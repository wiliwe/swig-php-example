...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(helloswigc)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(helloswigc)
ZEND_DECLARE_MODULE_GLOBALS(helloswigc)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(helloswigc_globals_id, zend_helloswigc_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(helloswigc_globals_id, zend_helloswigc_globals *, error_code )
#else
#define SWIG_ErrorMsg() (helloswigc_globals.error_msg)
#define SWIG_ErrorCode() (helloswigc_globals.error_code)
#endif
...
static void helloswigc_init_globals(zend_helloswigc_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void helloswigc_destroy_globals(zend_helloswigc_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_helloswigc_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_swig_helloswigc_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_echoStringC) {
  ...
  result = (char *)echoStringC((char const *)arg1);
  {
    if(!result) {
      ZVAL_NULL(return_value);
    } else {
...
/* arginfo subsection */
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_showhelloswigc, 0, 0, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_echostringc, 0, 0, 0)
...
static zend_function_entry helloswigc_functions[] = {
 SWIG_ZEND_NAMED_FE(showhelloswigc,_wrap_showHelloSwigC,swig_arginfo_showhelloswigc)
 SWIG_ZEND_NAMED_FE(echostringc,_wrap_echoStringC,swig_arginfo_echostringc)
 SWIG_ZEND_NAMED_FE(swig_helloswigc_alter_newobject,_wrap_swig_helloswigc_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_helloswigc_get_newobject,_wrap_swig_helloswigc_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry helloswigc_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"helloswigc",
    helloswigc_functions,
    PHP_MINIT(helloswigc),
    PHP_MSHUTDOWN(helloswigc),
    PHP_RINIT(helloswigc),
    PHP_RSHUTDOWN(helloswigc),
    PHP_MINFO(helloswigc),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &helloswigc_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &helloswigc_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(helloswigc)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(helloswigc, helloswigc_init_globals, helloswigc_destroy_globals);
...
/* cinit subsection */
SWIG_STRING_CONSTANT(TEST, "Macro: Hello, Swig-C");
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(helloswigc_globals_id);
#endif
    return SUCCESS;
}
