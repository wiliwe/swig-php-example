...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(helloswigcpp)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(helloswigcpp)
ZEND_DECLARE_MODULE_GLOBALS(helloswigcpp)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(helloswigcpp_globals_id, zend_helloswigcpp_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(helloswigcpp_globals_id, zend_helloswigcpp_globals *, error_code )
#else
#define SWIG_ErrorMsg() (helloswigcpp_globals.error_msg)
#define SWIG_ErrorCode() (helloswigcpp_globals.error_code)
#endif
...
static void helloswigcpp_init_globals(zend_helloswigcpp_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void helloswigcpp_destroy_globals(zend_helloswigcpp_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_helloswigcpp_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_swig_helloswigcpp_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_showPassedStrCpp) {
  ...
  result = (char *)showPassedStrCpp((char const *)arg1);
  {
    if(!result) {
      ZVAL_NULL(return_value);
    } else {
...
/* arginfo subsection */
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_showhelloswigcpp, 0, 0, 0)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(swig_arginfo_showpassedstrcpp, 0, 0, 0)
...
static zend_function_entry helloswigcpp_functions[] = {
 SWIG_ZEND_NAMED_FE(showhelloswigcpp,_wrap_showHelloSwigCpp,swig_arginfo_showhelloswigcpp)
 SWIG_ZEND_NAMED_FE(showpassedstrcpp,_wrap_showPassedStrCpp,swig_arginfo_showpassedstrcpp)
 SWIG_ZEND_NAMED_FE(swig_helloswigcpp_alter_newobject,_wrap_swig_helloswigcpp_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_helloswigcpp_get_newobject,_wrap_swig_helloswigcpp_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry helloswigcpp_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"helloswigcpp",
    helloswigcpp_functions,
    PHP_MINIT(helloswigcpp),
    PHP_MSHUTDOWN(helloswigcpp),
    PHP_RINIT(helloswigcpp),
    PHP_RSHUTDOWN(helloswigcpp),
    PHP_MINFO(helloswigcpp),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &helloswigcpp_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &helloswigcpp_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(helloswigcpp)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(helloswigcpp, helloswigcpp_init_globals, helloswigcpp_destroy_globals);
...
/* cinit subsection */
SWIG_STRING_CONSTANT(TEST, "Hello - C++");
SWIG_STRING_CONSTANT(Test, "World - C++");
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(helloswigcpp_globals_id);
#endif
    return SUCCESS;
}
